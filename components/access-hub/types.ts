...
export type ApiService = { id: string; code: string; name: string; description: string; transport: 'http' | 'worker_binding'; bindingName: string | null; baseUrl: string; authType: 'none' | 'bearer' | 'header' | 'query' | 'basic'; authConfigured: boolean; requiredPermissionId: string | null; requiredPermissionCode: string | null; requiredPermissionName: string | null; enabled: boolean; createdAt: string; updatedAt: string; apis: ServiceApi[] }
