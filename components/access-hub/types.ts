...
export type ApiService = { id: string; code: string; name: string; description: string; baseUrl: string; authType: 'none' | 'bearer' | 'header' | 'basic'; authConfigured: boolean; enabled: boolean; createdAt: string; updatedAt: string; apis: ServiceApi[] }
