...
export function ApiDocs() {
  return <div className="grid gap-7 xl:grid-cols-[minmax(0,1fr)_360px]">
    <section><p className="text-xs font-medium tracking-wide text-[#3157d5]">API reference</p><h2 className="mt-1 text-3xl font-semibold tracking-[-.03em]">接入 AccessHub</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500">所有账户级接口均使用当前登录会话。网关成功响应后会记入当天调用量。</p>
