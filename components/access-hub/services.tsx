...
type ServiceForm = { code: string; name: string; description: string; baseUrl: string; authType: ApiService['authType']; authToken: string; authHeader: string; authQuery: string; authValue: string; authUsername: string; authPassword: string; enabled: boolean }
...
const emptyService: ServiceForm = { code: '', name: '', description: '', baseUrl: '', authType: 'none', authToken: '', authHeader: 'x-api-key', authQuery: 'api_key', authValue: '', authUsername: '', authPassword: '', enabled: true }
