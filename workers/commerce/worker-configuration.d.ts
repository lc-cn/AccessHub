/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.commerce.jsonc --env-interface=CommerceWorkerEnv workers/commerce/worker-configuration.d.ts` (hash: e62172cde381b3e050fb1fe7ab6ef937)
