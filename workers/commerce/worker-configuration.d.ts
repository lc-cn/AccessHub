/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/commerce/wrangler.jsonc --env-interface=CommerceWorkerEnv workers/commerce/worker-configuration.d.ts` (hash: e62172cde381b3e050fb1fe7ab6ef937)
// Runtime types generated with workerd@1.20260915.1 2026-09-17 nodejs_compat
interface __BaseEnv_CommerceWorkerEnv {
	COMMERCE_INTERNAL_SECRET: string;
	ACCESSHUB: Fetcher /* accesshub */;
	ORDER_FULFILLMENT: Workflow<Parameters<import("./index").OrderFulfillmentWorkflow['run']>[0]['payload']>;
	SUBSCRIPTION_PERIOD: Workflow<Parameters<import("./index").SubscriptionPeriodWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
	}
	interface Env extends __BaseEnv_CommerceWorkerEnv {}
}
interface CommerceWorkerEnv extends __BaseEnv_CommerceWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMERCE_INTERNAL_SECRET">> {}
}
